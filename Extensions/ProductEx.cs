...
namespace Extensions
{
    public static class ProductEx
    {
        ...
        {
            return Product.Create(f1(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source), f9(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source), f9(source), f10(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source), f9(source), f10(source), f11(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source), f9(source), f10(source), f11(source), f12(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source), f9(source), f10(source), f11(source), f12(source), f13(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source), f9(source), f10(source), f11(source), f12(source), f13(source), f14(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source), f9(source), f10(source), f11(source), f12(source), f13(source), f14(source), f15(source));
        }
        ...
        {
            return Product.Create(f1(source), f2(source), f3(source), f4(source), f5(source), f6(source), f7(source), f8(source), f9(source), f10(source), f11(source), f12(source), f13(source), f14(source), f15(source), f16(source));
        }
        ...
        public static Product<T1> ToProduct<T1>(
            this Tuple<T1> tuple)
        {
            return Product.Create(tuple.Item1);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1, tuple.Rest.Item2);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1, tuple.Rest.Item2, tuple.Rest.Item3);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1, tuple.Rest.Item2, tuple.Rest.Item3, tuple.Rest.Item4);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1, tuple.Rest.Item2, tuple.Rest.Item3, tuple.Rest.Item4, tuple.Rest.Item5);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1, tuple.Rest.Item2, tuple.Rest.Item3, tuple.Rest.Item4, tuple.Rest.Item5, tuple.Rest.Item6);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1, tuple.Rest.Item2, tuple.Rest.Item3, tuple.Rest.Item4, tuple.Rest.Item5, tuple.Rest.Item6, tuple.Rest.Item7);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1, tuple.Rest.Item2, tuple.Rest.Item3, tuple.Rest.Item4, tuple.Rest.Item5, tuple.Rest.Item6, tuple.Rest.Item7, tuple.Rest.Rest.Item1);
        }
        ...
        {
            return Product.Create(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6, tuple.Item7, tuple.Rest.Item1, tuple.Rest.Item2, tuple.Rest.Item3, tuple.Rest.Item4, tuple.Rest.Item5, tuple.Rest.Item6, tuple.Rest.Item7, tuple.Rest.Rest.Item1, tuple.Rest.Rest.Item2);
        }
